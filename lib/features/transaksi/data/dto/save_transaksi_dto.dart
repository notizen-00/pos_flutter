  ...
  factory SaveTransaksiDto.fromEntity(SingleTransaksi transaksi, List<CashierItem> items) {
    return SaveTransaksiDto(
      transaksiData: TransaksiData(
        pelangganId: transaksi.pelangganId ?? 0,
        namaPelanggan: transaksi.namaPelanggan ?? '',
        meja: transaksi.meja ?? 0,
        authorId: transaksi.authorId ?? 0,
        shiftId: transaksi.shiftId ?? 0,
        status: transaksi.status,
        total: transaksi.total ?? 0,
        deskripsi: transaksi.deskripsi ?? '',
        totalTambahan: transaksi.totalTambahan ?? 0,
        pembayaran: transaksi.pembayaran ?? 0,
